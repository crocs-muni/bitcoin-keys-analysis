...
def demo():
 ...
 depending on the type of the public key and amount of corresponding signatures.")
    ...
    print("         parser.show_dict(parser.storage.ecdsa_data) # prints out the dictionary in a readable way with JSON indent.")
